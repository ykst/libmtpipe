#
#  Be sure to run `pod spec lint libmtpipe.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Yohsuke Yukishita" => "ykstyhsk@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Yohsuke Yukishita', 'other author'
  ...
  s.source       = { :git => "https://github.com/ykst/libmtpipe.git", :tag => "0.0.1" }
  ...
  s.source_files  = 'Sources', 'src/*.{h,c}', 'include/*.h', 'external/**/*.{h,c}'
